...
public class Properties extends MainActivity {
	...
	public static void update_preferences(){
		...
		appProp.fullscreen=MainActivity.mGlobalPrefs.getBoolean       ("fullscreen"           ,true);
		...
		appProp.systemPersistent=MainActivity.mGlobalPrefs.getBoolean ("systempersistent"     ,true);
		...
		sidebarProp.sideBarColor=MainActivity.mGlobalPrefs.getInt               ("sidebarcolor"    , Color.WHITE);
        sidebarProp.sideBarTextColor=MainActivity.mGlobalPrefs.getInt           ("sidebartextcolor", Color.BLACK);
		sidebarProp.showLabel=MainActivity.mGlobalPrefs.getBoolean              ("showfavoriteslabels", true);
		sidebarProp.swapLayout     =MainActivity.mGlobalPrefs.getBoolean        ("swapLayout"          ,true);
	...
	public static int numtodp(int in){
		return (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, in, MainActivity.activity.getResources().getDisplayMetrics());
	}
